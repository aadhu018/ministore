...
export default function Products(props) {
    ...
    return (
        <>
            ...
            <div id='planner' className="section-container">
                ...
                <div className="planner-container">
                    ...
                    <div className="planner-info">
                        ...
                        <ul>
                            <li>
                                <strong>Epic Dragon Artwork:</strong> Stunning hand-drawn dragon motifs and medieval-inspired borders make every month feel legendary.
                            </li>
                            <li>
            ...
            <div id='stickers' className="section-container">
                <div className="section-header">
                    <h2>Or Collect Your Favorite Tech</h2>
                    <p>Choose from our curated collection of tech stickers</p>
                </div>
                        ...
                        return (
                            <div key={stickerIndex} className="sticker-card">
                                <button onClick={() => setPortalImage(stickerImgUrl)} className="img-button">
                                    <img src={`low_res/${stickerImgUrl}.jpeg`} alt={
                                        `${stickerImgUrl}-low-res`
                                    } />
                                </button>
